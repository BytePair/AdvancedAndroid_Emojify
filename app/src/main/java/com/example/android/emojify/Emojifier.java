...
class Emojifier {
    ...
    /**
     * Method for detecting faces in a bitmap, replacing them with emojis,
     * and then returning the resulting bitmap
     *
    ...
    static Bitmap detectFacesAndOverlayEmoji(Context context, Bitmap picture) {
        ...
        if(faces.size() == 0) {
            ...
            for (int i = 0; i < faces.size(); ++i) {
                ...
                Bitmap emojiBitmap = getEmojiBitmap(context, face);
    ...
    /**
     * Switch statement to get the correct emoji bitmap
     ...
     * @return
     */
    private static Bitmap getEmojiBitmap(Context context, Face face) {
